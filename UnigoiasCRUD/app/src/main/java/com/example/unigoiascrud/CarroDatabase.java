...
@Database(entities = {CarroModal.class}, version = 1)
...
public abstract class CarroDatabase extends RoomDatabase {
    ...
    public static synchronized CarroDatabase getInstance(Context context) {
        ...
        if (instance == null) {
            ...
            Room.databaseBuilder(context.getApplicationContext(),
                            CarroDatabase.class, "carro_database")
    ...
    private static class PopulateDbAsyncTask extends AsyncTask<Void, Void,
            Void> {
        PopulateDbAsyncTask(CarroDatabase instance) {
